...
if __name__ == '__main__':
    ...
    data_2005 = read_csv_from_dir('../../ord_2005_1', cols, col_types)
    data_2006 = read_csv_from_dir('../../ord_2006_1', cols, col_types)
    data_2007 = read_csv_from_dir('../../ord_2007_1', cols, col_types)
    data_2008 = read_csv_from_dir('../../ord_2008_1', cols, col_types)

    # Create training set and test set
    cols = ['month', 'day', 'dow', 'hour', 'distance', 'days_from_holiday']
    train_y = data_2005['delay'] >= 15
    train = data_2006['delay'] >= 15
    train_y = [train_y, train]
    train = data_2007['delay'] >= 15
    train_y.append(train)
    train_x = [data_2005[cols],data_2006[cols],data_2007[cols]]
